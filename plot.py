...
def plot_task_a():
    ...
    sns.lineplot(data=final_df, x='Threads', y='Time', hue='Sched', style='Sched', markers=True, dashes=False)
...
def plot_task_b():
    ...
    plot = sns.lineplot(data=subset, x='Threads', y='Time', hue='Variant', style='Variant', markers=True, dashes=False)
    plot.set(yscale="log")
